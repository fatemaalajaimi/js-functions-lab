...
const calculateTip = (bill, amount) => {
...
const createUsername = (firstName, lastName) => {
  let array1 = firstName.split('')
  let array2 = lastName.split('')
  let sumOfBoth = array1.length + array2.length
  return `${array1[0]}${array1[1]}${array1[2]}${array2[0]}${array2[1]}${array2[2]}${sumOfBoth}`
}
